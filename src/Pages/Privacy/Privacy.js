    ...
    <>
      ...
      <div className='wrapper_policy'>
        ...
        <ul>
          ...
          <li>
            Information about your working place, status of COVID-19 test etc.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Create your professional profile based on your personal information
          </li>
        ...
        <p>
          We will keep your personal data for 5 years or as long as needed in
          order to conduct statistics and historical reviews and to administer
          your profile, unless is required under applicable law to delete it or
        ...
        <p>
          ...
          include what language you prefer and the location you are in. A mix of
