  ...
  return (
      ...
      <div className='wrapper_instruction'>
        ...
        <div className='step_instruction'>
          ...
          <p className='paragraph'>Keep track of visited rooms, therefore you will know if you were in close contact with person who might be in risk group. </p>
        </div>
        <div className='step_instruction'>
          <img className="step_img" alt="step3" src={step3}/>
          <h4 className='heading_small'>Get informed</h4>
          <p className='paragraph'>Just like that! The company will inform you when you was exposed to COVID-19 contact. We will also provide you with all necessary information</p>
        </div>
      </div>
  );
};
